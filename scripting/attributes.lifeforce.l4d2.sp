...
{
	name = "tAttributes Mod, Lifeforce for L4D(2)",
	author = "Thrawn",
	description = "A plugin for tAttributes Mod, Lifeforce, increases maximum health for L4D(2).",
...
public event_HealSuccess(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	{
		new iHealth = RoundFloat(GetEntProp(client, Prop_Data, "m_iMaxHealth") * 0.8 + 0.2 * GetClientHealth(client));
